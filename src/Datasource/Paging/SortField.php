...
class Sort_Field
{
     ...
     */
    public function __construct(protected string $field, protected ?string $default_direction = null, protected bool $locked = false)
    {
    }
    /**
     ...
     */
    public function get_direction(string $requested_direction, bool $direction_specified): string
    {
        if ($this->locked) {
            return $this->default_direction ?? self::ASC;
        }
        if (!$direction_specified && $this->default_direction) {
            return $this->default_direction;
        }
        if ($this->default_direction === static::DESC) {
            return $requested_direction === static::DESC ? static::ASC : static::DESC;
        }
