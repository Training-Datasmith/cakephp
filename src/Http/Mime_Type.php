...
class Mime_Type
{
     ...
     */
    public static function get_mime_types(?string $ext = null): ?array
    {
        if ($ext === null) {
            return static::$mime_types;
        }
        return static::$mime_types[$ext] ?? null;
    }
    /**
     ...
     */
    public static function get_mime_type(string $ext, ?string $default = null): ?string
    {
        return isset(static::$mime_types[$ext]) ? static::$mime_types[$ext][0] : $default;
    }
    /**
     ...
     */
    public static function add_mime_types(string $ext, array|string $mime_types): void
    {
        if (isset(static::$mime_types[$ext])) {
            static::$mime_types[$ext] = array_merge(static::$mime_types[$ext], (array) $mime_types);
            return;
        }
        static::$mime_types[$ext] = (array) $mime_types;
    }
    /**
     ...
     * @param array|string $mimeTypes The MIME types to associate with the file extension.
     */
    public static function set_mime_types(string $ext, array|string $mime_types): void
    {
        static::$mime_types[$ext] = (array) $mime_types;
    }
    /**
     ...
     */
    public static function get_extension(string $mime_type): ?string
    {
     ...
     */
    public static function get_mime_type_for_file(string $path, string $default = 'application/octet-stream'): string
    {
        $ext = strtolower(pathinfo($path, PATHINFO_EXTENSION));
        if (isset(static::$mime_types[$ext])) {
            return static::$mime_types[$ext][0];
        }
        $finfo = new finfo(FILEINFO_MIME);
        $mime_type = $finfo->file($path);
        return $mime_type === false ? $default : $mime_type;
    }
}