 ...
 */
class Transport_Registry extends Object_Registry
{
    /**
    ...
    protected function _resolve_class_name(string $class): ?string
    {
        ...
        return App::class_name($class, 'Mailer/Transport', 'Transport');
    }
    /**
     ...
     */
    protected function _create(object|string $class, string $alias, array $config): Abstract_Transport
    {
        if (is_object($class)) {
            return $class;
        }
