 ...
 */
class Unfold_Iterator extends Iterator_Iterator implements Recursive_Iterator
{
    /**
    ...
    public function get_children(): Recursive_Iterator
    {
        ...
        return new No_Children_Iterator($unfolder($current, $key, $this->_inner_iterator));
    }
}